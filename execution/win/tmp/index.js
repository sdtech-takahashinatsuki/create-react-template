...
async function copy(src, dest, { cwd, rename = identity, parents = true }) {
    ...
    if (sources.length === 0 || dest === "") {
        return result_1.createResult.ng(new Error("src or dest is empty"));
    }
...
async function installTemplate({ appName, root, framework, tailwind }) {
    ...
    const copySource = ["**/*"];
    const templatePath = "pkg" in process && process.pkg
        ? path_1.default.join(path_1.default.dirname(process.execPath), "template", framework, css)
    ...
    try {
        ...
        if (err instanceof Error) {
            console.error("Failed to update package.json name:", err?.message ?? err);
        }
        else {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.createResult = exports.RESULT_NG = exports.RESULT_OK = void 0;
